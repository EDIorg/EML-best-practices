...
3.  \<**binaryRasterFormat**>, which describes a raster data file such as a GeoTIFF, which is useful when publishing spatial data files (See the [spatial data](../guide-special-cases/spatial-data.qmd) chapter of the “Data Package Design for Special Cases” companion document).
